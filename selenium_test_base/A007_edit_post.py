...
try:
    ...
    with open('edit_data_in.csv', encoding='UTF-8') as csvfile:
    ...
    with open('edit_data_out.csv', 'w', encoding='UTF-8')as f:
    ...
    def collect_edited_posts_and_write_to_file(l_index):
        ...
        with open('edit_data_out.csv', 'a', encoding='UTF-8')as file:
